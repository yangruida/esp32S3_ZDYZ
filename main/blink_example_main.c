...
#define I2C_ADDRESS         0x20        /*!< I2C address of slave dev, can be ESP_IO_EXPANDER_I2C_xl9555_ADDRESS_XXX  */
...
void test_io_expander_tca95xx_16bit(void)
{
    i2c_bus_init();
...
//     }
test_io_expander_tca95xx_16bit();
}
